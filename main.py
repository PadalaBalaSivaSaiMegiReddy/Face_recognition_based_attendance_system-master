...
def contact():
    mess._show(title='Contact us', message="Please contact us on : 'Aryanzaddyisheretohelp@gmail.com' ")
...
def check_haarcascadefile():
    ...
    if exists:
        ...
        mess._show(title='Some file missing', message='Aryan Says Sorryy')
        window.destroy()
...
message3 = tk.Label(window, text="Mark It" ,fg="white",bg="#262523" ,width=55 ,height=1,font=('times', 29, ' bold '))
